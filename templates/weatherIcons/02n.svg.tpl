<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="<?= $this->e($x)?>" y="<?= $this->e($y)?>"
	 width="<?= $this->e($width)?>" height="<?= $this->e($width)?>" viewBox="0 0 512 512" xml:space="preserve">
<g id="Grid_1_">
	<g id="Layer_1_1_">
		<g id="Grid">
			<g>
